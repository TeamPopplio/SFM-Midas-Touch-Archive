...
void Cvar_UnregisterMidasCvars()
{
	...
	// First deletes all plugin ConVars and then readds the ConVars outside of Midas
	...
	while (command)
	{
		// Detect which non-midas commands have this flag set, and add them back afterwards
